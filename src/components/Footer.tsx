            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center gap-4 pt-2" aria-label="Social media links">
                  ...
                  <a href="https://linkedin.com/creativity-freaks" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary transition-colors"><Linkedin className="h-5 w-5" /></a>
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground hover:text-primary transition-colors"><Facebook className="h-5 w-5" /></a>
